class Hotel extends Edifici {
  ...
  serveiHabitacions() {
    ...
    missatge +=
      '<li>Es necessitaran:<b> ' + numPersones + ' </b>persones.</li>';
  ...
  toString() {
    ...
    missatge +=
      '<li>Superfície:<b> ' + this._superficie + ' </b>m<sup>2</sup>.</li>';
    missatge +=
      '<li>Número de plantes:<b> ' + this._numPlantes + ' </b>plantes.';
    missatge +=
      "<li>Número d'habitacions:<b> " +
      this._numHabitacions +
      ' </b>habitacions.</li></ul>';
  ...
  toString2() {
    ...
    missatge +=
      "Número d'habitacions:<b> " + this._numHabitacions + ' </b>habitacions.';
