...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/jordi/.vscode/extensions/wallabyjs.console-ninja-1.0.358/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20826a56c733150c3746bbDRwBUhsGWQZXBgQDBgZSUVYGB1sM', mode: 'build'}); } catch(cjsError) { try { import('file:///home/jordi/.vscode/extensions/wallabyjs.console-ninja-1.0.358/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20826a56c733150c3746bbDRwBUhsGWQZXBgQDBgZSUVYGB1sM', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
